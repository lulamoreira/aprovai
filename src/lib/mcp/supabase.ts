...
function supabasePublishableKey(): string {
  ...
  throw new Error("Nenhuma chave pública do Supabase configurada");
}

/** Cliente que age como o usuário autenticado do token OAuth (RLS aplicada). */
...
export function ok(dados: unknown) {
  return {
